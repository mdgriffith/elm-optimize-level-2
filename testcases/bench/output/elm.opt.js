(function (scope) {
    ...
    */
    ...
    var _Platform_worker = F4(function (impl, flagDecoder, debugMetadata, args) {
        return _Platform_initialize(flagDecoder, args, impl.bS, impl.b6, impl.b4, function () { return function () { }; });
    });
    ...
    var _Browser_element = _Debugger_element || F4(function (impl, flagDecoder, debugMetadata, args) {
        return _Platform_initialize(flagDecoder, args, impl.bS, impl.b6, impl.b4, function (sendToApp, initialModel) {
            var view = impl.b8;
            /**/
    ...
    var $elm$url$Url$Url = F6(function (protocol, host, port_, path, query, fragment) {
        return { a0: fragment, a2: host, a8: path, bb: port_, bg: protocol, bh: query };
    });
    ...
    var $author$project$Main$suite = A2($elm_explorations$benchmark$Benchmark$describe, "Benchmarks", _List_fromArray([
        ...
        A2($elm_explorations$benchmark$Benchmark$benchmark, "1000 record updates", function (_v1) {
            return A3($elm$core$List$foldl, $author$project$Main$updateRecord, { aO: 1, bq: 3, br: 2 }, $author$project$Main$many);
        })
    ]));
