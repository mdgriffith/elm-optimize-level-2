(function (scope) {
    ...
    */
    ...
    var $mdgriffith$style_elements$Style$Internal$Intermediate$makeRenderable = function (cls) {
        ...
        switch (cls.$) {
            ...
            case 1:
                ...
                return A2($elm$core$List$cons, A3($mdgriffith$style_elements$Style$Internal$Intermediate$RenderableMedia, mediaRule.bi, A2($mdgriffith$style_elements$Style$Internal$Selector$render, $elm$core$Maybe$Nothing, mediaRule.B), rendered), subelements);
            default:
                var str = cls.a;
    ...
    var $mdgriffith$style_elements$Style$Internal$Intermediate$finalize = function (intermediates) {
        ...
        return {
            bI: A2($elm$core$String$join, "\n", A2($elm$core$List$map, finalizeCss, intermediates)),
            bR: A2($elm$core$List$concatMap, $mdgriffith$style_elements$Style$Internal$Intermediate$asFindable, intermediates)
        };
    };
    ...
    var $mdgriffith$style_elements$Style$Internal$Render$Property$background = function (prop) {
        ...
        switch (prop.$) {
            ...
            case 0:
                var image = prop.a;
                return _List_fromArray([
                    _Utils_Tuple2("background-image", "url(" + (image.aS + ")")),
                    _Utils_Tuple2("background-position", $elm$core$String$fromFloat(image.be.a) + ("px " + ($elm$core$String$fromFloat(image.be.b) + "px"))),
    ...
    var $mdgriffith$style_elements$Style$Internal$Render$Value$shadow = function (_v0) {
        ...
        return A2($elm$core$String$join, " ", A2($elm$core$List$filterMap, $elm$core$Basics$identity, _List_fromArray([
            (shadowModel.bX === "inset") ? $elm$core$Maybe$Just("inset") : $elm$core$Maybe$Nothing,
            $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.a7.a) + "px"),
            $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.a7.b) + "px"),
            $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.bC) + "px"),
            ((shadowModel.bX === "text") || (shadowModel.bX === "drop")) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just($elm$core$String$fromFloat(shadowModel.b4) + "px"),
            $elm$core$Maybe$Just($mdgriffith$style_elements$Style$Internal$Render$Value$color(shadowModel.bH))
        ])));
    };
    ...
    var $elm$regex$Regex$fromString = function (string) {
        return A2($elm$regex$Regex$fromStringWith, { bF: false, bZ: false }, string);
    };
    ...
    var $elm_explorations$benchmark$Benchmark$Runner$Box$style = _List_fromArray([
        ...
        $mdgriffith$style_elements$Style$Shadow$box({
            bC: 2,
            bH: A4($mdgriffith$style_elements$Style$rgba, 15 / 255, 30 / 255, 45 / 255, 0.1),
    ...
    var $author$project$Main$suite = A2($elm_explorations$benchmark$Benchmark$describe, "Benchmarks", _List_fromArray([
        ...
        A2($elm_explorations$benchmark$Benchmark$benchmark, "1000 record updates", function (_v1) {
            return A3($elm$core$List$foldl, $author$project$Main$updateRecord, { aO: 1, br: 3, bs: 2 }, $author$project$Main$many);
        })
    ]));
