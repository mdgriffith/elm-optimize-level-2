(function (scope) {
    ...
    */
    ...
    var $author$project$Benchmark$Runner$Json$encodeResultItem = function (item) {
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2("name", $elm$json$Json$Encode$string(item.aj)),
            _Utils_Tuple2("tags", A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, item.aq)),
            _Utils_Tuple2("status", $author$project$Benchmark$Runner$Json$encodeStatus(item.ap))
        ]));
    };
    ...
    var $author$project$Benchmark$Runner$Json$flattenReportGroup = F2(function (groups, report) {
        switch (report.$) {
            case 0:
                var name = report.a;
                var status = report.b;
            ...
            case 1:
                ...
                return A2($elm$core$List$map, function (_v1) {
                    ...
                    return {
                        aj: name,
                        ap: status,
                        aq: _Utils_ap(groups, _List_fromArray([tag]))
                    };
                }, statuses);
            default:
                var name = report.a;
                var reports = report.b;
                return A2($elm$core$List$concatMap, $author$project$Benchmark$Runner$Json$flattenReportGroup(_Utils_ap(groups, _List_fromArray([name]))), reports);
        }
    });
            ...
            case 1:
                ...
                return A2($elm$core$List$map, function (_v1) {
                    ...
                    return {
                        aj: name,
                        ap: status,
                        aq: _List_fromArray([tag])
                    };
                }, statuses);
            default:
                var name = report.a;
                var reports = report.b;
                return A2($elm$core$List$concatMap, $author$project$Benchmark$Runner$Json$flattenReportGroup(_List_fromArray([name])), reports);
        }
    };
    ...
    var $author$project$Main$updateShape = F2(function (upd, shape) {
        switch (upd.$) {
            case 0:
                var s = upd.a;
                var a = shape.aB;
    ...
    var $author$project$Main$updateValues = _List_fromArray([
        ...
        $author$project$Main$IntTuple(_Utils_Tuple2(1, 400)),
        $author$project$Main$Str(""),
        $author$project$Main$Boolean(true),
        $author$project$Main$Integer(-5),
        $author$project$Main$IntTuple(_Utils_Tuple2(600, -100))
    ]);
    var $author$project$Main$suite = A2($elm_explorations$benchmark$Benchmark$describe, "Basics", _List_fromArray([
        A2($elm_explorations$benchmark$Benchmark$benchmark, "Update single record", function (_v0) {
