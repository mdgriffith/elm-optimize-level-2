(function (scope) {
    ...
    */
    ...
    var _Platform_worker = F4(function (impl, flagDecoder, debugMetadata, args) {
        return _Platform_initialize(flagDecoder, args, impl.cs, impl.cL, impl.cI, function () { return function () { }; });
    });
    ...
    var _Browser_element = _Debugger_element || F4(function (impl, flagDecoder, debugMetadata, args) {
        return _Platform_initialize(flagDecoder, args, impl.cs, impl.cL, impl.cI, function (sendToApp, initialModel) {
            var view = impl.cN;
            /**/
    ...
    var $elm$core$Array$builderToArray = F2(function (reverseNodeList, builder) {
        if (!builder.v) {
            return A4($elm$core$Array$Array_elm_builtin, $elm$core$Elm$JsArray$length(builder.x), $elm$core$Array$shiftStep, $elm$core$Elm$JsArray$empty, builder.x);
        }
        else {
            ...
            return A4($elm$core$Array$Array_elm_builtin, $elm$core$Elm$JsArray$length(builder.x) + treeLen, A2($elm$core$Basics$max, 5, depth * $elm$core$Array$shiftStep), tree, builder.x);
        }
    });
    ...
    var $elm$core$Array$initializeHelp = F5(function (fn, fromIndex, len, nodeList, tail) {
        initializeHelp: while (true) {
            if (fromIndex < 0) {
                return A2($elm$core$Array$builderToArray, false, { y: nodeList, v: (len / $elm$core$Array$branchFactor) | 0, x: tail });
            }
            else {
    ...
    var $elm$url$Url$Url = F6(function (protocol, host, port_, path, query, fragment) {
        return { br: fragment, bu: host, bF: path, bI: port_, bN: protocol, bO: query };
    });
    ...
    var $author$project$Benchmark$Runner$Json$next = function (benchmark) {
        return $elm_explorations$benchmark$Benchmark$done(benchmark) ? $elm$core$Platform$Cmd$none : A2($elm$core$Task$perform, $elm$core$Basics$identity, $author$project$Benchmark$Runner$Json$breakForRender($elm_explorations$benchmark$Benchmark$step(benchmark)));
    };
    var $author$project$Benchmark$Runner$Json$init = F2(function (benchmark, _v0) {
        return _Utils_Tuple2(benchmark, $author$project$Benchmark$Runner$Json$next(benchmark));
    });
    ...
    var $author$project$Benchmark$Runner$Json$runsPerSecond = A2($elm$core$Basics$composeR, $BrianHicks$elm_trend$Trend$Linear$line, A2($elm$core$Basics$composeR, function (a) {
        ...
        switch (status.$) {
            case 0:
                return $elm$json$Json$Encode$object(_List_fromArray([
                    _Utils_Tuple2("status", $elm$json$Json$Encode$string("cold"))
                ]));
            case 1:
                return $elm$json$Json$Encode$object(_List_fromArray([
                    _Utils_Tuple2("status", $elm$json$Json$Encode$string("unsized"))
                ]));
            case 2:
                var i = status.a;
                var samples = status.b;
            ...
            case 3:
                var error = status.a;
                return $elm$json$Json$Encode$object(_List_fromArray([
                    _Utils_Tuple2("status", $elm$json$Json$Encode$string("failure"))
                ]));
            default:
                var samples = status.a;
                var quickTrend = status.b;
                return $elm$json$Json$Encode$object(_List_fromArray([
                    _Utils_Tuple2("status", $elm$json$Json$Encode$string("success")),
                    _Utils_Tuple2("runsPerSecond", $elm$json$Json$Encode$int($author$project$Benchmark$Runner$Json$runsPerSecond(quickTrend))),
                    _Utils_Tuple2("goodnessOfFit", $elm$json$Json$Encode$float($BrianHicks$elm_trend$Trend$Linear$goodnessOfFit(quickTrend)))
                ]));
        }
    };
    var $author$project$Benchmark$Runner$Json$encodeResultItem = function (_v0) {
        ...
        return $elm$json$Json$Encode$object(_List_fromArray([
            ...
            _Utils_Tuple2("status", $author$project$Benchmark$Runner$Json$encodeStatus(status))
        ]));
    };
    ...
    var $author$project$Benchmark$Runner$Json$flattenReportGroup = F2(function (group, report) {
        switch (report.$) {
            case 0:
                var name = report.a;
                var status = report.b;
            ...
            case 1:
                ...
                return A2($elm$core$List$map, function (_v1) {
                    var tag = _v1.a;
                    var val = _v1.b;
            ...
            default:
                ...
                return A2($elm$core$List$concatMap, $author$project$Benchmark$Runner$Json$flattenReportGroup(group + (", " + (name + ", "))), reports);
        }
    });
    var $author$project$Benchmark$Runner$Json$flattenReport = function (report) {
        switch (report.$) {
            ...
            default:
                var name = report.a;
                var reports = report.b;
                return A2($elm$core$List$concatMap, $author$project$Benchmark$Runner$Json$flattenReportGroup(name), reports);
        }
    };
    ...
    var $author$project$Benchmark$Runner$Json$encodeReport = function (report) {
        return A2($elm$json$Json$Encode$list, $author$project$Benchmark$Runner$Json$encodeResultItem, $author$project$Benchmark$Runner$Json$flattenReport(report));
    };
    ...
    var $author$project$Benchmark$Runner$Json$encode = function (benchmark) {
        return $author$project$Benchmark$Runner$Json$encodeReport($elm_explorations$benchmark$Benchmark$Reporting$fromBenchmark(benchmark));
    };
    var $author$project$Benchmark$Runner$Json$update = F3(function (sendReport, msg, model) {
        var benchmark = msg;
    ...
    var $author$project$Markdown$Block$Heading = F2(function (a, b) {
        return { $: 4, a: a, b: b };
    });
    ...
    var $author$project$Markdown$Block$HtmlDeclaration = F2(function (a, b) {
        return { $: 3, a: a, b: b };
    });
    var $author$project$Markdown$Block$HtmlElement = F3(function (a, b, c) {
        return { $: 0, a: a, b: b, c: c };
    });
    var $author$project$Markdown$Block$HtmlInline = function (a) {
        return { $: 0, a: a };
    };
    var $author$project$Markdown$Block$Image = F3(function (a, b, c) {
    ...
    var $author$project$Markdown$Block$Link = F3(function (a, b, c) {
        return { $: 1, a: a, b: b, c: c };
    });
    var $author$project$Markdown$Block$ListItem = F2(function (a, b) {
        return { $: 0, a: a, b: b };
    });
    ...
    var $author$project$Markdown$Block$OrderedList = F2(function (a, b) {
        return { $: 2, a: a, b: b };
    });
    ...
    var $author$project$Markdown$Block$Table = F2(function (a, b) {
        return { $: 6, a: a, b: b };
    });
    ...
    var $author$project$Markdown$Parser$addReference = F2(function (state, linkRef) {
        return {
            af: A2($elm$core$List$cons, linkRef, state.af),
            T: state.T
        };
    });
    ...
    var $elm$parser$Parser$Advanced$chompWhileHelp = F5(function (isGood, offset, row, col, s0) {
        chompWhileHelp: while (true) {
            ...
            if (_Utils_eq(newOffset, -1)) {
                return A3($elm$parser$Parser$Advanced$Good, _Utils_cmp(s0.h, offset) < 0, 0, { bl: col, l: s0.l, p: s0.p, h: offset, cE: row, b: s0.b });
            }
            else {
    ...
    var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
        return function (s) {
            return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.h, s.cE, s.bl, s);
        };
    };
    ...
    var $author$project$Parser$Token$newline = A2($elm$parser$Parser$Advanced$Token, "\n", $elm$parser$Parser$Expecting("a newline"));
    ...
    var $elm$parser$Parser$Advanced$DeadEnd = F4(function (row, col, problem, contextStack) {
        return { bl: col, cc: contextStack, cC: problem, cE: row };
    });
    var $elm$parser$Parser$Advanced$Empty = { $: 0 };
    var $elm$parser$Parser$Advanced$fromState = F2(function (s, x) {
        return A2($elm$parser$Parser$Advanced$AddRight, $elm$parser$Parser$Advanced$Empty, A4($elm$parser$Parser$Advanced$DeadEnd, s.cE, s.bl, x, s.l));
    });
    ...
    var $elm$parser$Parser$Advanced$token = function (_v0) {
        ...
        return function (s) {
            var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.h, s.cE, s.bl, s.b);
            var newOffset = _v1.a;
            var newRow = _v1.b;
            var newCol = _v1.c;
            return _Utils_eq(newOffset, -1) ? A2($elm$parser$Parser$Advanced$Bad, false, A2($elm$parser$Parser$Advanced$fromState, s, expecting)) : A3($elm$parser$Parser$Advanced$Good, progress, 0, { bl: newCol, l: s.l, p: s.p, h: newOffset, cE: newRow, b: s.b });
        };
    };
    var $elm$parser$Parser$Advanced$symbol = $elm$parser$Parser$Advanced$token;
    var $author$project$Markdown$Parser$blankLine = A2($elm$parser$Parser$Advanced$map, function (_v0) {
        return $author$project$Markdown$RawBlock$BlankLine;
    }, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$backtrackable($elm$parser$Parser$Advanced$chompWhile($author$project$Helpers$isSpaceOrTab)), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$newline)));
    ...
    var $author$project$Parser$Token$space = A2($elm$parser$Parser$Advanced$Token, " ", $elm$parser$Parser$Expecting("a space"));
    var $author$project$Markdown$Parser$blockQuoteStarts = _List_fromArray([
        ...
        A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$backtrackable($elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$space)), $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
            $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, ">", $elm$parser$Parser$Expecting(" >"))),
            $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, " >", $elm$parser$Parser$Expecting("  >"))),
            $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, "  >", $elm$parser$Parser$Expecting("   >")))
        ])))
    ...
    var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
        return function (s) {
            var _v0 = A5(_Parser_findSubString, str, s.h, s.cE, s.bl, s.b);
            var newOffset = _v0.a;
            var newRow = _v0.b;
            var newCol = _v0.c;
            var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.b) : newOffset;
            return A3($elm$parser$Parser$Advanced$Good, _Utils_cmp(s.h, adjustedOffset) < 0, 0, { bl: newCol, l: s.l, p: s.p, h: adjustedOffset, cE: newRow, b: s.b });
        };
    };
    var $elm$parser$Parser$Advanced$end = function (x) {
        return function (s) {
            return _Utils_eq($elm$core$String$length(s.b), s.h) ? A3($elm$parser$Parser$Advanced$Good, false, 0, s) : A2($elm$parser$Parser$Advanced$Bad, false, A2($elm$parser$Parser$Advanced$fromState, s, x));
        };
    };
    var $author$project$Helpers$endOfFile = $elm$parser$Parser$Advanced$end($elm$parser$Parser$Expecting("end of input"));
    var $author$project$Helpers$endOfLineOrFile = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $elm$parser$Parser$Advanced$mapChompedString = F2(function (func, _v0) {
        ...
        return function (s0) {
            ...
            if (_v1.$ === 1) {
                ...
                var a = _v1.b;
                var s1 = _v1.c;
                return A3($elm$parser$Parser$Advanced$Good, p, A2(func, A3($elm$core$String$slice, s0.h, s1.h, s0.b), a), s1);
            }
        };
    });
    ...
    var $author$project$Markdown$Parser$blockQuote = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Markdown$RawBlock$BlockQuote), $elm$parser$Parser$Advanced$oneOf($author$project$Markdown$Parser$blockQuoteStarts)), $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $author$project$Markdown$RawBlock$Heading = F2(function (a, b) {
        return { $: 0, a: a, b: b };
    });
    ...
    var $author$project$Markdown$Parser$dropTrailingHashes = function (headingString) {
        return A2($elm$core$String$endsWith, "#", headingString) ? $author$project$Markdown$Parser$dropTrailingHashes($elm$core$String$trimRight(A2($elm$core$String$dropRight, 1, headingString))) : headingString;
    };
    var $author$project$Parser$Token$hash = A2($elm$parser$Parser$Advanced$Token, "#", $elm$parser$Parser$Expecting("a `#`"));
    ...
    var $author$project$Markdown$Parser$heading = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Markdown$RawBlock$Heading), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$hash)), A2($elm$parser$Parser$Advanced$andThen, function (additionalHashes) {
    ...
    }, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompWhile($author$project$Markdown$Parser$isHash)))), A2($elm$parser$Parser$Advanced$mapChompedString, F2(function (headingText, _v0) {
        return $author$project$Markdown$Parser$dropTrailingHashes($elm$core$String$trimLeft(headingText));
    }), $elm$parser$Parser$Advanced$chompUntilEndOr("\n")));
    var $author$project$HtmlParser$Cdata = function (a) {
        return { $: 3, a: a };
    };
    var $author$project$HtmlParser$Element = F3(function (a, b, c) {
        return { $: 0, a: a, b: b, c: c };
    });
    ...
    var $elm$parser$Parser$Advanced$chompIf = F2(function (isGood, expecting) {
        return function (s) {
            var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.h, s.b);
            return _Utils_eq(newOffset, -1) ? A2($elm$parser$Parser$Advanced$Bad, false, A2($elm$parser$Parser$Advanced$fromState, s, expecting)) : (_Utils_eq(newOffset, -2) ? A3($elm$parser$Parser$Advanced$Good, true, 0, { bl: 1, l: s.l, p: s.p, h: s.h + 1, cE: s.cE + 1, b: s.b }) : A3($elm$parser$Parser$Advanced$Good, true, 0, { bl: s.bl + 1, l: s.l, p: s.p, h: newOffset, cE: s.cE, b: s.b }));
        };
    });
    ...
    var $author$project$HtmlParser$tagName = A2($elm$parser$Parser$Advanced$mapChompedString, F2(function (name, _v0) {
        return $elm$core$String$toLower(name);
    }), A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$chompIf, $author$project$HtmlParser$tagNameCharacter, $author$project$HtmlParser$expectTagNameCharacter), $elm$parser$Parser$Advanced$chompWhile($author$project$HtmlParser$tagNameCharacter)));
    ...
    var $author$project$HtmlParser$entities = $elm$core$Dict$fromList(_List_fromArray([
        _Utils_Tuple2("amp", "&"),
        _Utils_Tuple2("lt", "<"),
        _Utils_Tuple2("gt", ">"),
        _Utils_Tuple2("apos", "'"),
    ...
    var $author$project$HtmlParser$escapedChar = function (end_) {
        ...
        return A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$HtmlParser$symbol("&")), A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$andThen, process, $elm$parser$Parser$Advanced$getChompedString(A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$chompIf, isEntityChar, $elm$parser$Parser$Expecting("an entity character")), $elm$parser$Parser$Advanced$chompWhile(isEntityChar)))), $author$project$HtmlParser$symbol(";")));
    };
    var $author$project$HtmlParser$textStringStep = F3(function (closingChar, predicate, accum) {
    ...
    var $author$project$HtmlParser$textString = function (closingChar) {
        ...
        return A2($elm$parser$Parser$Advanced$loop, "", A2($author$project$HtmlParser$textStringStep, closingChar, predicate));
    };
    var $author$project$HtmlParser$attributeValue = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$HtmlParser$symbol("\"")), A2($elm$parser$Parser$Advanced$ignorer, $author$project$HtmlParser$textString("\""), $author$project$HtmlParser$symbol("\""))),
        A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$HtmlParser$symbol("'")), A2($elm$parser$Parser$Advanced$ignorer, $author$project$HtmlParser$textString("'"), $author$project$HtmlParser$symbol("'")))
    ]));
    var $author$project$HtmlParser$keepOldest = F2(function (_new, mValue) {
        if (!mValue.$) {
            var v = mValue.a;
            return $elm$core$Maybe$Just(v);
        }
    ...
    var $author$project$HtmlParser$attributesStep = function (attrs) {
        var process = F2(function (name, value) {
            return $elm$parser$Parser$Advanced$Loop(A3($elm$core$Dict$update, $elm$core$String$toLower(name), $author$project$HtmlParser$keepOldest(value), attrs));
        });
        return $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
            A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$succeed(process), A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $author$project$HtmlParser$attributeName, $author$project$HtmlParser$whiteSpace), $author$project$HtmlParser$symbol("=")), $author$project$HtmlParser$whiteSpace)), A2($elm$parser$Parser$Advanced$ignorer, $author$project$HtmlParser$attributeValue, $author$project$HtmlParser$whiteSpace)),
            $elm$parser$Parser$Advanced$succeed($elm$parser$Parser$Advanced$Done(attrs))
        ]));
    };
    var $author$project$HtmlParser$attributes = A2($elm$parser$Parser$Advanced$map, A2($elm$core$Dict$foldl, F3(function (key, value, accum) {
        return A2($elm$core$List$cons, { a8: key, bg: value }, accum);
    }), _List_Nil), A2($elm$parser$Parser$Advanced$loop, $elm$core$Dict$empty, $author$project$HtmlParser$attributesStep));
    var $author$project$HtmlParser$cdata = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$HtmlParser$symbol("<![CDATA[")), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr("]]>")), $author$project$HtmlParser$symbol("]]>")));
    var $author$project$HtmlParser$childrenStep = F2(function (options, accum) {
    ...
    var $author$project$HtmlParser$closingTag = function (startTagName) {
        ...
        return A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $author$project$HtmlParser$symbol("</"), $author$project$HtmlParser$whiteSpace), closingTagName), $author$project$HtmlParser$whiteSpace), $author$project$HtmlParser$symbol(">"));
    };
    ...
    var $author$project$HtmlParser$comment = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$HtmlParser$Comment), $elm$parser$Parser$Advanced$token($author$project$HtmlParser$toToken("<!--"))), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr("-->")), $elm$parser$Parser$Advanced$token($author$project$HtmlParser$toToken("-->"))));
    var $author$project$HtmlParser$Declaration = F2(function (a, b) {
        return { $: 5, a: a, b: b };
    });
    var $author$project$HtmlParser$expectUppercaseCharacter = $elm$parser$Parser$Expecting("at least 1 uppercase character");
    var $author$project$HtmlParser$allUppercase = $elm$parser$Parser$Advanced$getChompedString(A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$chompIf, $elm$core$Char$isUpper, $author$project$HtmlParser$expectUppercaseCharacter), $elm$parser$Parser$Advanced$chompWhile($elm$core$Char$isUpper)));
    var $author$project$HtmlParser$oneOrMoreWhiteSpace = A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$chompIf, $author$project$HtmlParser$isWhitespace, $elm$parser$Parser$Expecting("at least one whitespace")), $elm$parser$Parser$Advanced$chompWhile($author$project$HtmlParser$isWhitespace));
    var $author$project$HtmlParser$docType = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$HtmlParser$Declaration), $author$project$HtmlParser$symbol("<!")), A2($elm$parser$Parser$Advanced$ignorer, $author$project$HtmlParser$allUppercase, $author$project$HtmlParser$oneOrMoreWhiteSpace)), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr(">")), $author$project$HtmlParser$symbol(">")));
    var $author$project$HtmlParser$ProcessingInstruction = function (a) {
        return { $: 4, a: a };
    };
    var $author$project$HtmlParser$processingInstruction = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$HtmlParser$ProcessingInstruction), $author$project$HtmlParser$symbol("<?")), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr("?>")), $author$project$HtmlParser$symbol("?>")));
    ...
    var $author$project$HtmlParser$textNodeStringStepOptions = _List_fromArray([
        ...
        }, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$chompIf, $author$project$HtmlParser$isNotTextNodeIgnoreChar, $elm$parser$Parser$Expecting("is not & or <")), $elm$parser$Parser$Advanced$chompWhile($author$project$HtmlParser$isNotTextNodeIgnoreChar))),
    ...
    var $author$project$HtmlParser$textNodeString = $elm$parser$Parser$Advanced$getChompedString(A2($elm$parser$Parser$Advanced$loop, 0, $author$project$HtmlParser$textNodeStringStep));
    var $author$project$HtmlParser$children = function (startTagName) {
        return A2($elm$parser$Parser$Advanced$loop, _List_Nil, $author$project$HtmlParser$childrenStep($author$project$HtmlParser$childrenStepOptions(startTagName)));
    };
        ...
        return _List_fromArray([
            ...
            A2($elm$parser$Parser$Advanced$andThen, function (text) {
                return $elm$core$String$isEmpty(text) ? A2($elm$parser$Parser$Advanced$map, F2(function (_v2, accum) {
                    return $elm$parser$Parser$Advanced$Done($elm$core$List$reverse(accum));
                }), $author$project$HtmlParser$closingTag(startTagName)) : $elm$parser$Parser$Advanced$succeed(function (accum) {
                    return $elm$parser$Parser$Advanced$Loop(A2($elm$core$List$cons, $author$project$HtmlParser$Text(text), accum));
                });
    ...
    var $author$project$HtmlParser$elementContinuation = function (startTagName) {
        return A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$HtmlParser$Element(startTagName)), $author$project$HtmlParser$whiteSpace), A2($elm$parser$Parser$Advanced$ignorer, $author$project$HtmlParser$attributes, $author$project$HtmlParser$whiteSpace)), $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
            A2($elm$parser$Parser$Advanced$map, function (_v0) {
                return _List_Nil;
            }, $author$project$HtmlParser$symbol("/>")),
            A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$HtmlParser$symbol(">")), $author$project$HtmlParser$children(startTagName))
        ])));
    };
    ...
    function $author$project$HtmlParser$cyclic$element() {
        return A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$HtmlParser$symbol("<")), A2($elm$parser$Parser$Advanced$andThen, $author$project$HtmlParser$elementContinuation, $author$project$HtmlParser$tagName));
    }
    ...
    var $author$project$Parser$Token$tab = A2($elm$parser$Parser$Advanced$Token, "\t", $elm$parser$Parser$Expecting("a tab"));
    var $author$project$Markdown$Parser$exactlyFourSpaces = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $author$project$Markdown$Parser$indentedCodeBlock = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Markdown$RawBlock$IndentedCodeBlock), $author$project$Markdown$Parser$exactlyFourSpaces), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr("\n")), $author$project$Helpers$endOfLineOrFile));
    var $author$project$Markdown$RawBlock$OrderedListBlock = F2(function (a, b) {
        return { $: 4, a: a, b: b };
    });
    var $author$project$Parser$Token$closingParen = A2($elm$parser$Parser$Advanced$Token, ")", $elm$parser$Parser$Expecting("a `)`"));
    var $author$project$Parser$Token$dot = A2($elm$parser$Parser$Advanced$Token, ".", $elm$parser$Parser$Expecting("a `.`"));
    var $author$project$Markdown$OrderedList$endOrNewline = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$newline),
        $elm$parser$Parser$Advanced$end($elm$parser$Parser$Expecting("end of input"))
    ]));
    ...
    var $author$project$Markdown$OrderedList$itemBody = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        ...
        A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed(""), $author$project$Markdown$OrderedList$endOrNewline)
    ]));
    var $author$project$Parser$Extra$positiveInteger = A2($elm$parser$Parser$Advanced$mapChompedString, F2(function (str, _v0) {
    ...
    var $author$project$Markdown$OrderedList$singleItemParser = function (listMarker) {
        return A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $elm$parser$Parser$Advanced$backtrackable(A2($elm$parser$Parser$Advanced$ignorer, $author$project$Parser$Extra$positiveInteger, $elm$parser$Parser$Advanced$symbol(listMarker)))), $author$project$Markdown$OrderedList$itemBody);
    };
    var $author$project$Markdown$OrderedList$statementsHelp = F2(function (itemParser, revStmts) {
        return $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $author$project$Markdown$OrderedList$parseSubsequentItems = F3(function (startingIndex, listMarker, firstItem) {
        ...
        }, A2($elm$parser$Parser$Advanced$loop, _List_Nil, $author$project$Markdown$OrderedList$statementsHelp($author$project$Markdown$OrderedList$singleItemParser(listMarker))));
    });
    var $author$project$Markdown$OrderedList$positiveIntegerMaxOf9Digits = A2($elm$parser$Parser$Advanced$andThen, function (parsed) {
    ...
    var $author$project$Markdown$OrderedList$parser = function (previousWasBody) {
        return A2($elm$parser$Parser$Advanced$andThen, $elm$core$Basics$identity, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$succeed($author$project$Markdown$OrderedList$parseSubsequentItems), $elm$parser$Parser$Advanced$backtrackable(previousWasBody ? A2($elm$parser$Parser$Advanced$andThen, $author$project$Markdown$OrderedList$validateStartsWith1, $author$project$Markdown$OrderedList$positiveIntegerMaxOf9Digits) : $author$project$Markdown$OrderedList$positiveIntegerMaxOf9Digits)), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$backtrackable($elm$parser$Parser$Advanced$oneOf(_List_fromArray([
            A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Parser$Token$dot), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$dot)),
            A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Parser$Token$closingParen), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$closingParen))
        ]))), $author$project$Parser$Extra$oneOrMore($author$project$Helpers$isSpaceOrTab))), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr("\n")), $author$project$Markdown$OrderedList$endOrNewline)));
    };
    var $author$project$Markdown$Parser$orderedListBlock = function (previousWasBody) {
        return A2($elm$parser$Parser$Advanced$map, function (_v0) {
            ...
            return A2($author$project$Markdown$RawBlock$OrderedListBlock, startingIndex, A2($elm$core$List$map, $elm$core$Basics$identity, unparsedLines));
        }, $author$project$Markdown$OrderedList$parser(previousWasBody));
    };
    var $author$project$Markdown$Inline$CodeInline = function (a) {
        return { $: 2, a: a };
    };
    var $author$project$Markdown$Inline$Emphasis = F2(function (a, b) {
        return { $: 6, a: a, b: b };
    });
    ...
    var $author$project$Markdown$Inline$Image = F3(function (a, b, c) {
        return { $: 4, a: a, b: b, c: c };
    });
    var $author$project$Markdown$Inline$Link = F3(function (a, b, c) {
    ...
    var $author$project$Markdown$InlineParser$matchToInline = function (_v0) {
        ...
        switch (_v1.$) {
            ...
            case 3:
                ...
                var text = _v2.a;
                var url = _v2.b;
                return A3($author$project$Markdown$Inline$Link, url, $elm$core$Maybe$Nothing, _List_fromArray([
            ...
            case 4:
                ...
                return A3($author$project$Markdown$Inline$Link, url, maybeTitle, $author$project$Markdown$InlineParser$matchesToInlines(match.A));
            case 5:
                var _v4 = _v1.a;
                var url = _v4.a;
                var maybeTitle = _v4.b;
                return A3($author$project$Markdown$Inline$Image, url, maybeTitle, $author$project$Markdown$InlineParser$matchesToInlines(match.A));
            case 6:
                var model = _v1.a;
                return $author$project$Markdown$Inline$HtmlInline(model);
            default:
                var length = _v1.a;
                return A2($author$project$Markdown$Inline$Emphasis, length, $author$project$Markdown$InlineParser$matchesToInlines(match.A));
        }
    };
    ...
    var $author$project$Markdown$InlineParser$prepareChildMatch = F2(function (parentMatch, childMatch) {
        return { o: childMatch.o - parentMatch.z, A: childMatch.A, s: childMatch.s - parentMatch.z, t: childMatch.t, I: childMatch.I - parentMatch.z, z: childMatch.z - parentMatch.z, u: childMatch.u };
    });
    var $author$project$Markdown$InlineParser$addChild = F2(function (parentMatch, childMatch) {
        return {
            o: parentMatch.o,
            A: A2($elm$core$List$cons, A2($author$project$Markdown$InlineParser$prepareChildMatch, parentMatch, childMatch), parentMatch.A),
            s: parentMatch.s,
            t: parentMatch.t,
            I: parentMatch.I,
            z: parentMatch.z,
    ...
    var $author$project$Markdown$InlineParser$organizeMatchesHelp = F3(function (remaining, _v0, matchesTail) {
        organizeMatchesHelp: while (true) {
            var prevMatch = _v0;
            if (!remaining.b) {
                return A2($elm$core$List$cons, $author$project$Markdown$InlineParser$organizeChildren(prevMatch), matchesTail);
            }
            else {
                var match = remaining.a;
                var rest = remaining.b;
                if (_Utils_cmp(prevMatch.o, match.s) < 1) {
                    var $temp$remaining = rest, $temp$_v0 = match, $temp$matchesTail = A2($elm$core$List$cons, $author$project$Markdown$InlineParser$organizeChildren(prevMatch), matchesTail);
                    ...
                    if ((_Utils_cmp(prevMatch.s, match.s) < 0) && (_Utils_cmp(prevMatch.o, match.o) > 0)) {
                        var $temp$remaining = rest, $temp$_v0 = A2($author$project$Markdown$InlineParser$addChild, prevMatch, match), $temp$matchesTail = matchesTail;
                        remaining = $temp$remaining;
                        _v0 = $temp$_v0;
                        matchesTail = $temp$matchesTail;
                        continue organizeMatchesHelp;
    ...
    var $elm$regex$Regex$Match = F4(function (match, index, number, submatches) {
        return { c: index, aG: match, cy: number, be: submatches };
    });
    var $elm$regex$Regex$fromStringWith = _Regex_fromStringWith;
    var $elm$regex$Regex$fromString = function (string) {
        return A2($elm$regex$Regex$fromStringWith, { b9: false, cx: false }, string);
    };
    var $elm$regex$Regex$never = _Regex_never;
    var $author$project$Markdown$Entity$decimalRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("&#([0-9]{1,8});"));
    ...
    var $author$project$Markdown$Entity$validUnicode = function (_int) {
        return ($author$project$Markdown$Entity$isValidUnicode(_int) && (!$author$project$Markdown$Entity$isBadEndUnicode(_int))) ? $elm$core$String$fromChar($elm$core$Char$fromCode(_int)) : $elm$core$String$fromChar($elm$core$Char$fromCode(65533));
    };
    ...
    var $author$project$Markdown$Entity$entitiesRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("&([0-9a-zA-Z]+);"));
    var $author$project$Markdown$Entity$entities = $elm$core$Dict$fromList(_List_fromArray([
    ...
    var $author$project$Markdown$Helpers$escapableRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\+)([!\"#$%&\\'()*+,./:;<=>?@[\\\\\\]^_`{|}~-])"));
    ...
    var $author$project$Markdown$Entity$hexadecimalRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("&#[Xx]([0-9a-fA-F]{1,8});"));
    ...
    var $author$project$Markdown$InlineParser$parseTextMatch = F3(function (rawText, _v2, parsedMatches) {
        var matchModel = _v2;
        var updtMatch = {
            o: matchModel.o,
            A: A3($author$project$Markdown$InlineParser$parseTextMatches, matchModel.t, _List_Nil, matchModel.A),
            s: matchModel.s,
            t: matchModel.t,
            I: matchModel.I,
            z: matchModel.z,
        ...
        if (!parsedMatches.b) {
            var finalStr = A2($elm$core$String$dropLeft, matchModel.o, rawText);
            ...
            if (!_v4.$) {
                ...
                return _Utils_eq(matchModel.o, matchHead.s) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.o, matchHead.s) < 0) ? A2($elm$core$List$cons, updtMatch, A2($elm$core$List$cons, $author$project$Markdown$InlineParser$normalMatch(A3($elm$core$String$slice, matchModel.o, matchHead.s, rawText)), parsedMatches)) : parsedMatches);
            }
        }
    });
    var $author$project$Markdown$InlineParser$parseTextMatches = F3(function (rawText, parsedMatches, matches) {
        parseTextMatches: while (true) {
            if (!matches.b) {
                if (!parsedMatches.b) {
                    ...
                    return (matchModel.s > 0) ? A2($elm$core$List$cons, $author$project$Markdown$InlineParser$normalMatch(A2($elm$core$String$left, matchModel.s, rawText)), parsedMatches) : parsedMatches;
                }
            }
            else {
                var match = matches.a;
                var matchesTail = matches.b;
                var $temp$rawText = rawText, $temp$parsedMatches = A3($author$project$Markdown$InlineParser$parseTextMatch, rawText, match, parsedMatches), $temp$matches = matchesTail;
    ...
    var $author$project$Markdown$InlineParser$angleBracketLTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\*)(\\<)"));
    ...
    var $author$project$Markdown$InlineParser$findAngleBracketLTokens = function (str) {
        return A2($elm$core$List$filterMap, $author$project$Markdown$InlineParser$regMatchToAngleBracketLToken, A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$angleBracketLTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$angleBracketRTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\*)(\\>)"));
    ...
    var $author$project$Markdown$InlineParser$findAngleBracketRTokens = function (str) {
        return A2($elm$core$List$filterMap, $author$project$Markdown$InlineParser$regMatchToAngleBracketRToken, A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$angleBracketRTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$asteriskEmphasisTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\*)([^*])?(\\*+)([^*])?"));
    var $author$project$Markdown$InlineParser$EmphasisToken = F2(function (a, b) {
        return { $: 7, a: a, b: b };
    });
    ...
    var $author$project$Markdown$InlineParser$containPunctuation = A2($elm$core$String$foldl, F2(function (c, accum) {
    ...
    var $author$project$Markdown$InlineParser$containSpace = A2($elm$core$String$foldl, F2(function (c, accum) {
    ...
    var $author$project$Markdown$InlineParser$regMatchToEmphasisToken = F3(function (_char, rawText, regMatch) {
        var _v0 = regMatch.be;
        if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) && _v0.b.b.b.b) {
            ...
            var mLeftFringe = ((!(!regMatch.c)) && (!leftFringeLength)) ? $elm$core$Maybe$Just(A3($elm$core$String$slice, regMatch.c - 1, regMatch.c, rawText)) : maybeLeftFringe;
            ...
            if ((delimiterLength <= 0) || ((_char === "_") && ((lFringeRank === 2) && (rFringeRank === 2)))) {
                ...
                return $elm$core$Maybe$Just({
                    c: index,
                    i: delimiterLength,
                    n: A2($author$project$Markdown$InlineParser$EmphasisToken, _char, { aU: lFringeRank, a_: rFringeRank })
                });
            }
        }
        else {
    ...
    var $author$project$Markdown$InlineParser$findAsteriskEmphasisTokens = function (str) {
        return A2($elm$core$List$filterMap, A2($author$project$Markdown$InlineParser$regMatchToEmphasisToken, "*", str), A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$asteriskEmphasisTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$codeTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\*)(\\`+)"));
    ...
    var $author$project$Markdown$InlineParser$findCodeTokens = function (str) {
        return A2($elm$core$List$filterMap, $author$project$Markdown$InlineParser$regMatchToCodeToken, A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$codeTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$hardBreakTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(?:(\\\\+)|( {2,}))\\n"));
    ...
    var $author$project$Markdown$InlineParser$softAsHardLineBreakTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(?:(\\\\+)|( *))\\n"));
    var $author$project$Markdown$InlineParser$findHardBreakTokens = function (str) {
        return $author$project$Markdown$InlineParser$softAsHardLineBreak ? A2($elm$core$List$filterMap, $author$project$Markdown$InlineParser$regMatchToSoftHardBreakToken, A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$softAsHardLineBreakTokenRegex, str)) : A2($elm$core$List$filterMap, $author$project$Markdown$InlineParser$regMatchToHardBreakToken, A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$hardBreakTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$linkImageCloseTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\*)(\\])"));
    ...
    var $author$project$Markdown$InlineParser$findLinkImageCloseTokens = function (str) {
        return A2($elm$core$List$filterMap, $author$project$Markdown$InlineParser$regMatchToLinkImageCloseToken, A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$linkImageCloseTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$linkImageOpenTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\*)(\\!)?(\\[)"));
    ...
    var $author$project$Markdown$InlineParser$findLinkImageOpenTokens = function (str) {
        return A2($elm$core$List$filterMap, $author$project$Markdown$InlineParser$regMatchToLinkImageOpenToken, A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$linkImageOpenTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$underlineEmphasisTokenRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("(\\\\*)([^_])?(\\_+)([^_])?"));
    var $author$project$Markdown$InlineParser$findUnderlineEmphasisTokens = function (str) {
        return A2($elm$core$List$filterMap, A2($author$project$Markdown$InlineParser$regMatchToEmphasisToken, "_", str), A2($elm$regex$Regex$find, $author$project$Markdown$InlineParser$underlineEmphasisTokenRegex, str));
    };
    var $author$project$Markdown$InlineParser$mergeByIndex = F2(function (left, right) {
        if (left.b) {
            var lfirst = left.a;
            var lrest = left.b;
            if (right.b) {
                var rfirst = right.a;
                var rrest = right.b;
                return (_Utils_cmp(lfirst.c, rfirst.c) < 0) ? A2($elm$core$List$cons, lfirst, A2($author$project$Markdown$InlineParser$mergeByIndex, lrest, right)) : A2($elm$core$List$cons, rfirst, A2($author$project$Markdown$InlineParser$mergeByIndex, left, rrest));
            }
            else {
                return left;
            }
    ...
    var $author$project$Markdown$InlineParser$tokenize = function (rawText) {
        return A2($author$project$Markdown$InlineParser$mergeByIndex, $author$project$Markdown$InlineParser$findAngleBracketRTokens(rawText), A2($author$project$Markdown$InlineParser$mergeByIndex, $author$project$Markdown$InlineParser$findAngleBracketLTokens(rawText), A2($author$project$Markdown$InlineParser$mergeByIndex, $author$project$Markdown$InlineParser$findHardBreakTokens(rawText), A2($author$project$Markdown$InlineParser$mergeByIndex, $author$project$Markdown$InlineParser$findLinkImageCloseTokens(rawText), A2($author$project$Markdown$InlineParser$mergeByIndex, $author$project$Markdown$InlineParser$findLinkImageOpenTokens(rawText), A2($author$project$Markdown$InlineParser$mergeByIndex, $author$project$Markdown$InlineParser$findUnderlineEmphasisTokens(rawText), A2($author$project$Markdown$InlineParser$mergeByIndex, $author$project$Markdown$InlineParser$findAsteriskEmphasisTokens(rawText), $author$project$Markdown$InlineParser$findCodeTokens(rawText))))))));
    };
    ...
    var $author$project$Markdown$InlineParser$decodeUrlRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("%(?:3B|2C|2F|3F|3A|40|26|3D|2B|24|23|25)"));
    var $elm$url$Url$percentDecode = _Url_percentDecode;
    var $elm$url$Url$percentEncode = _Url_percentEncode;
    var $author$project$Markdown$InlineParser$encodeUrl = A2($elm$core$Basics$composeR, $elm$url$Url$percentEncode, A2($elm$regex$Regex$replace, $author$project$Markdown$InlineParser$decodeUrlRegex, function (match) {
        return A2($elm$core$Maybe$withDefault, match.aG, $elm$url$Url$percentDecode(match.aG));
    }));
    var $author$project$Markdown$InlineParser$urlRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("^([A-Za-z][A-Za-z0-9.+\\-]{1,31}:[^<>\\x00-\\x20]*)$"));
    var $author$project$Markdown$InlineParser$autolinkToMatch = function (_v0) {
        var match = _v0;
        return A2($elm$regex$Regex$contains, $author$project$Markdown$InlineParser$urlRegex, match.t) ? $elm$core$Result$Ok(_Utils_update(match, {
            u: $author$project$Markdown$InlineParser$AutolinkType(_Utils_Tuple2(match.t, $author$project$Markdown$InlineParser$encodeUrl(match.t)))
        })) : $elm$core$Result$Err(match);
    };
    var $elm$regex$Regex$findAtMost = _Regex_findAtMost;
    var $author$project$Markdown$Helpers$insideSquareBracketRegex = "[^\\[\\]\\\\]*(?:\\\\.[^\\[\\]\\\\]*)*";
    var $author$project$Markdown$InlineParser$refLabelRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("^\\[\\s*(" + ($author$project$Markdown$Helpers$insideSquareBracketRegex + ")\\s*\\]")));
    ...
    var $author$project$Markdown$InlineParser$prepareUrlAndTitle = F2(function (rawUrl, maybeTitle) {
        return _Utils_Tuple2($author$project$Markdown$InlineParser$encodeUrl($author$project$Markdown$Helpers$formatStr(rawUrl)), A2($elm$core$Maybe$map, $author$project$Markdown$Helpers$formatStr, maybeTitle));
    });
    var $author$project$Markdown$InlineParser$refRegexToMatch = F3(function (matchModel, references, maybeRegexMatch) {
        var refLabel = function (str) {
            return $elm$core$String$isEmpty(str) ? matchModel.t : str;
        }(A2($elm$core$Maybe$withDefault, matchModel.t, A2($elm$core$Maybe$withDefault, $elm$core$Maybe$Nothing, A2($elm$core$Maybe$andThen, A2($elm$core$Basics$composeR, function ($) {
            return $.be;
        }, $elm$core$List$head), maybeRegexMatch))));
        var _v0 = A2($elm$core$Dict$get, $author$project$Markdown$Helpers$prepareRefLabel(refLabel), references);
        if (_v0.$ === 1) {
            return $elm$core$Maybe$Nothing;
        }
        else {
            ...
            var type_ = function () {
                ...
                if (_v3.$ === 5) {
                    return $author$project$Markdown$InlineParser$ImageType(A2($author$project$Markdown$InlineParser$prepareUrlAndTitle, rawUrl, maybeTitle));
                }
                else {
                    return $author$project$Markdown$InlineParser$LinkType(A2($author$project$Markdown$InlineParser$prepareUrlAndTitle, rawUrl, maybeTitle));
                }
            }();
    ...
    var $author$project$Markdown$InlineParser$checkForInlineReferences = F3(function (remainText, _v0, references) {
        var tempMatch = _v0;
        var matches = A3($elm$regex$Regex$findAtMost, 1, $author$project$Markdown$InlineParser$refLabelRegex, remainText);
        return A3($author$project$Markdown$InlineParser$refRegexToMatch, tempMatch, references, $elm$core$List$head(matches));
    });
    ...
    var $author$project$Markdown$InlineParser$inlineLinkTypeOrImageTypeRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("^\\(\\s*" + ($author$project$Markdown$InlineParser$hrefRegex + ($author$project$Markdown$Helpers$titleRegex + "\\s*\\)"))));
    ...
    var $author$project$Markdown$InlineParser$inlineLinkTypeOrImageTypeRegexToMatch = F2(function (matchModel, regexMatch) {
        var _v0 = regexMatch.be;
        if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
            ...
            var maybeTitle = $author$project$Markdown$Helpers$returnFirstJust(_List_fromArray([maybeTitleSingleQuotes, maybeTitleDoubleQuotes, maybeTitleParenthesis]));
            ...
            var maybeRawUrl = $author$project$Markdown$Helpers$returnFirstJust(_List_fromArray([maybeRawUrlAngleBrackets, maybeRawUrlWithoutBrackets]));
    ...
    var $author$project$Markdown$InlineParser$checkForInlineLinkTypeOrImageType = F3(function (remainText, _v0, refs) {
        var tempMatch = _v0;
    ...
    var $author$project$Markdown$InlineParser$checkParsedAheadOverlapping = F2(function (_v0, remainMatches) {
        var match = _v0;
    ...
    var $author$project$Markdown$InlineParser$emailRegex = A2($elm$core$Maybe$withDefault, $elm$regex$Regex$never, $elm$regex$Regex$fromString("^([a-zA-Z0-9.!#$%&'*+\\/=?^_`{|}~\\-]+@[a-zA-Z0-9](?:[a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9\\-]{0,61}[a-zA-Z0-9])?)*)$"));
    var $author$project$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
        var match = _v0;
        return A2($elm$regex$Regex$contains, $author$project$Markdown$InlineParser$emailRegex, match.t) ? $elm$core$Result$Ok(_Utils_update(match, {
            u: $author$project$Markdown$InlineParser$AutolinkType(_Utils_Tuple2(match.t, "mailto:" + $author$project$Markdown$InlineParser$encodeUrl(match.t)))
        })) : $elm$core$Result$Err(match);
    };
    var $author$project$Markdown$InlineParser$findTokenHelp = F3(function (innerTokens, isToken, tokens) {
    ...
    var $author$project$Markdown$InlineParser$findToken = F2(function (isToken, tokens) {
        return A3($author$project$Markdown$InlineParser$findTokenHelp, _List_Nil, isToken, tokens);
    });
    var $author$project$Markdown$InlineParser$HtmlToken = F2(function (a, b) {
        return { $: 6, a: a, b: b };
    });
    ...
    var $author$project$Markdown$InlineParser$htmlToToken = F2(function (rawText, _v0) {
        var match = _v0;
        var consumedCharacters = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$succeed(F3(function (startOffset, htmlTag, endOffset) {
            return { bv: htmlTag, i: endOffset - startOffset };
        })), $elm$parser$Parser$Advanced$getOffset), $author$project$HtmlParser$html), $elm$parser$Parser$Advanced$getOffset);
        var parsed = A2($elm$parser$Parser$Advanced$run, consumedCharacters, A2($elm$core$String$dropLeft, match.s, rawText));
        if (!parsed.$) {
    ...
    var $author$project$Markdown$Helpers$ifError = F2(function (_function, result) {
        if (!result.$) {
            return result;
        }
        else {
    ...
    var $author$project$Markdown$InlineParser$isCloseToken = F2(function (htmlModel, token) {
        return false;
    });
    var $author$project$Markdown$InlineParser$isCodeTokenPair = F2(function (closeToken, openToken) {
        var _v0 = openToken.n;
        if (!_v0.$) {
            if (!_v0.a) {
                var _v1 = _v0.a;
    ...
    var $author$project$Markdown$InlineParser$isOpenEmphasisToken = F2(function (closeToken, openToken) {
        var _v0 = openToken.n;
        if (_v0.$ === 7) {
            var openChar = _v0.a;
            var open = _v0.b;
            ...
            if (_v1.$ === 7) {
                var closeChar = _v1.a;
                var close = _v1.b;
                return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.aU, open.a_) || _Utils_eq(close.aU, close.a_)) ? (!(!A2($elm$core$Basics$modBy, 3, closeToken.i + openToken.i))) : true) : false;
            }
            else {
                return false;
            }
    ...
    var $author$project$Markdown$InlineParser$tokenToMatch = F2(function (token, type_) {
        return { o: token.c + token.i, A: _List_Nil, s: token.c, t: "", I: 0, z: 0, u: type_ };
    });
    var $author$project$Markdown$InlineParser$lineBreakTTM = F5(function (remaining, tokens, matches, refs, rawText) {
        lineBreakTTM: while (true) {
            if (!remaining.b) {
                ...
                var _v1 = token.n;
                if (_v1.$ === 9) {
                    var $temp$remaining = tokensTail, $temp$tokens = tokens, $temp$matches = A2($elm$core$List$cons, A2($author$project$Markdown$InlineParser$tokenToMatch, token, $author$project$Markdown$InlineParser$HardLineBreakType), matches), $temp$refs = refs, $temp$rawText = rawText;
                    remaining = $temp$remaining;
                    tokens = $temp$tokens;
                    matches = $temp$matches;
                    refs = $temp$refs;
    ...
    var $author$project$Markdown$InlineParser$removeParsedAheadTokens = F2(function (_v0, tokensTail) {
        var match = _v0;
        return A2($elm$core$List$filter, function (token) {
            return _Utils_cmp(token.c, match.o) > -1;
        }, tokensTail);
    });
    var $author$project$Markdown$InlineParser$angleBracketsToMatch = F6(function (closeToken, escaped, matches, references, rawText, _v39) {
        var openToken = _v39.a;
        var remainTokens = _v39.c;
        var result = A2($author$project$Markdown$Helpers$ifError, $author$project$Markdown$InlineParser$emailAutolinkTypeToMatch, $author$project$Markdown$InlineParser$autolinkToMatch(A7($author$project$Markdown$InlineParser$tokenPairToMatch, references, rawText, function (s) {
            return s;
        }, $author$project$Markdown$InlineParser$CodeType, openToken, closeToken, _List_Nil)));
        if (result.$ === 1) {
    ...
    var $author$project$Markdown$InlineParser$codeAutolinkTypeHtmlTagTTM = F5(function (remaining, tokens, matches, references, rawText) {
        codeAutolinkTypeHtmlTagTTM: while (true) {
            if (!remaining.b) {
                return A5($author$project$Markdown$InlineParser$htmlElementTTM, $elm$core$List$reverse(tokens), _List_Nil, matches, references, rawText);
            }
            else {
                var token = remaining.a;
                var tokensTail = remaining.b;
                ...
                switch (_v31.$) {
                    case 0:
                        ...
                        var _v32 = A2($author$project$Markdown$InlineParser$findToken, $author$project$Markdown$InlineParser$isCodeTokenPair(token), tokens);
                        if (!_v32.$) {
                            var code = _v32.a;
    ...
    var $author$project$Markdown$InlineParser$codeToMatch = F5(function (closeToken, matches, references, rawText, _v27) {
    ...
    var $author$project$Markdown$InlineParser$emphasisTTM = F5(function (remaining, tokens, matches, references, rawText) {
        emphasisTTM: while (true) {
            if (!remaining.b) {
                return A5($author$project$Markdown$InlineParser$lineBreakTTM, $elm$core$List$reverse(tokens), _List_Nil, matches, references, rawText);
            }
            else {
                var token = remaining.a;
                var tokensTail = remaining.b;
                ...
                if (_v22.$ === 7) {
                    ...
                    if (_Utils_eq(leftFringeRank, rightFringeRank)) {
                        if ((!(!rightFringeRank)) && ((_char !== "_") || (rightFringeRank === 1))) {
                            var _v23 = A2($author$project$Markdown$InlineParser$findToken, $author$project$Markdown$InlineParser$isOpenEmphasisToken(token), tokens);
                            if (!_v23.$) {
                                var found = _v23.a;
                        ...
                        if (_Utils_cmp(leftFringeRank, rightFringeRank) < 0) {
                            ...
                            var _v25 = A2($author$project$Markdown$InlineParser$findToken, $author$project$Markdown$InlineParser$isOpenEmphasisToken(token), tokens);
                            if (!_v25.$) {
                                var found = _v25.a;
    ...
    var $author$project$Markdown$InlineParser$emphasisToMatch = F5(function (references, rawText, closeToken, tokensTail, _v20) {
        ...
        var updt = (!remainLength) ? { aR: closeToken, aH: openToken, aZ: remainTokens, a2: tokensTail } : ((remainLength > 0) ? {
            ...
            aZ: A2($elm$core$List$cons, _Utils_update(openToken, { i: remainLength }), remainTokens),
            a2: tokensTail
        } : {
            aR: _Utils_update(closeToken, { i: openToken.i }),
            aH: openToken,
            aZ: remainTokens,
            a2: A2($elm$core$List$cons, _Utils_update(closeToken, { c: closeToken.c + openToken.i, i: -remainLength }), tokensTail)
        });
        var match = A7($author$project$Markdown$InlineParser$tokenPairToMatch, references, rawText, function (s) {
            return s;
        }, $author$project$Markdown$InlineParser$EmphasisType(updt.aH.i), updt.aH, updt.aR, $elm$core$List$reverse(innerTokens));
        return _Utils_Tuple3(updt.a2, match, updt.aZ);
    });
    var $author$project$Markdown$InlineParser$htmlElementTTM = F5(function (remaining, tokens, matches, references, rawText) {
        htmlElementTTM: while (true) {
            if (!remaining.b) {
                return A5($author$project$Markdown$InlineParser$linkImageTypeTTM, $elm$core$List$reverse(tokens), _List_Nil, matches, references, rawText);
            }
            else {
                var token = remaining.a;
                var tokensTail = remaining.b;
                ...
                if (_v16.$ === 6) {
                    ...
                    if (isOpen === 1) {
                        var $temp$remaining = tokensTail, $temp$tokens = tokens, $temp$matches = A2($elm$core$List$cons, A2($author$project$Markdown$InlineParser$tokenToMatch, token, $author$project$Markdown$InlineParser$HtmlType(htmlModel)), matches), $temp$references = references, $temp$rawText = rawText;
                        remaining = $temp$remaining;
                        tokens = $temp$tokens;
                        matches = $temp$matches;
                        references = $temp$references;
                        ...
                        var _v18 = A2($author$project$Markdown$InlineParser$findToken, $author$project$Markdown$InlineParser$isCloseToken(htmlModel), tokensTail);
                        if (_v18.$ === 1) {
                            var $temp$remaining = tokensTail, $temp$tokens = tokens, $temp$matches = A2($elm$core$List$cons, A2($author$project$Markdown$InlineParser$tokenToMatch, token, $author$project$Markdown$InlineParser$HtmlType(htmlModel)), matches), $temp$references = references, $temp$rawText = rawText;
                            remaining = $temp$remaining;
                            tokens = $temp$tokens;
                            ...
                            var newTail = _v19.c;
                            var newMatch = A7($author$project$Markdown$InlineParser$tokenPairToMatch, references, rawText, function (s) {
                                return s;
                            }, $author$project$Markdown$InlineParser$HtmlType(htmlModel), token, closeToken, innerTokens);
    ...
    var $author$project$Markdown$InlineParser$linkImageTypeTTM = F5(function (remaining, tokens, matches, references, rawText) {
        linkImageTypeTTM: while (true) {
            if (!remaining.b) {
                return A5($author$project$Markdown$InlineParser$emphasisTTM, $elm$core$List$reverse(tokens), _List_Nil, matches, references, rawText);
            }
            else {
                var token = remaining.a;
                var tokensTail = remaining.b;
    ...
    var $author$project$Markdown$InlineParser$linkOrImageTypeToMatch = F6(function (closeToken, tokensTail, oldMatches, references, rawText, _v1) {
        var openToken = _v1.a;
        ...
        var findTempMatch = function (isLinkType) {
            return A7($author$project$Markdown$InlineParser$tokenPairToMatch, references, rawText, function (s) {
                return s;
            }, isLinkType ? $author$project$Markdown$InlineParser$LinkType(_Utils_Tuple2("", $elm$core$Maybe$Nothing)) : $author$project$Markdown$InlineParser$ImageType(_Utils_Tuple2("", $elm$core$Maybe$Nothing)), openToken, closeToken, $elm$core$List$reverse(innerTokens));
        };
        var _v2 = openToken.n;
        switch (_v2.$) {
            case 2:
                ...
                if (_v3.$ === 1) {
                    ...
                    if (!_v4.$) {
                        var matches = _v4.a;
                        return $elm$core$Maybe$Just(_Utils_Tuple3(A2($author$project$Markdown$InlineParser$removeParsedAheadTokens, match, tokensTail), matches, remainTokens));
                    }
                    else {
                        return $elm$core$Maybe$Just(removeOpenToken);
                    }
            ...
            case 1:
                if (!_v2.a) {
                    ...
                    if (_v6.$ === 1) {
                        ...
                        if (!_v7.$) {
                            var matches = _v7.a;
                            return $elm$core$Maybe$Just(_Utils_Tuple3(A2($author$project$Markdown$InlineParser$removeParsedAheadTokens, match, tokensTail), matches, A2($elm$core$List$map, inactivateLinkOpenToken, remainTokens)));
                        }
                        else {
                            return $elm$core$Maybe$Just(removeOpenToken);
                        }
    ...
    var $author$project$Markdown$InlineParser$tokenPairToMatch = F7(function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
    ...
    var $author$project$Markdown$InlineParser$tokensToMatches = F4(function (tokens, matches, references, rawText) {
    ...
    var $author$project$Markdown$InlineParser$parse = F2(function (refs, rawText_) {
        var rawText = $elm$core$String$trim(rawText_);
        var tokens = $author$project$Markdown$InlineParser$tokenize(rawText);
        return $author$project$Markdown$InlineParser$matchesToInlines(A3($author$project$Markdown$InlineParser$parseTextMatches, rawText, _List_Nil, $author$project$Markdown$InlineParser$organizeMatches(A4($author$project$Markdown$InlineParser$tokensToMatches, tokens, _List_Nil, refs, rawText))));
    });
    var $author$project$Markdown$Parser$thisIsDefinitelyNotAnHtmlTag = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $author$project$Markdown$Parser$parseAsParagraphInsteadOfHtmlBlock = $elm$parser$Parser$Advanced$backtrackable(A2($elm$parser$Parser$Advanced$mapChompedString, F2(function (rawLine, _v0) {
        return $author$project$Markdown$RawBlock$Body(rawLine);
    }), A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$token(A2($elm$parser$Parser$Advanced$Token, "<", $elm$parser$Parser$Expecting("<"))), $author$project$Markdown$Parser$thisIsDefinitelyNotAnHtmlTag), $elm$parser$Parser$Advanced$chompUntilEndOr("\n")), $author$project$Helpers$endOfLineOrFile)));
    ...
    var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
        ...
        var expecting = _v0.b;
        return function (s) {
            var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.h, s.cE, s.bl, s.b);
            var newOffset = _v1.a;
            var newRow = _v1.b;
            var newCol = _v1.c;
            return _Utils_eq(newOffset, -1) ? A2($elm$parser$Parser$Advanced$Bad, false, A4($elm$parser$Parser$Advanced$fromInfo, newRow, newCol, expecting, s.l)) : A3($elm$parser$Parser$Advanced$Good, _Utils_cmp(s.h, newOffset) < 0, 0, { bl: newCol, l: s.l, p: s.p, h: newOffset, cE: newRow, b: s.b });
        };
    };
    var $author$project$Markdown$CodeBlock$openingCodeFence = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$map, function (delimiter) {
            return _Utils_Tuple2("`", delimiter);
        }, $elm$parser$Parser$Advanced$getChompedString(A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, "```", $elm$parser$Parser$ExpectingSymbol("```"))), $elm$parser$Parser$Advanced$chompWhile(function (c) {
            return c === "`";
        })))),
        A2($elm$parser$Parser$Advanced$map, function (delimiter) {
            return _Utils_Tuple2("~", delimiter);
    ...
    var $author$project$Markdown$CodeBlock$parserHelp = A2($elm$parser$Parser$Advanced$andThen, function (_v0) {
        var _char = _v0.a;
        var delimiter = _v0.b;
        return A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$succeed(F2(function (language, body) {
            return {
                b6: body,
                bB: $elm$core$String$isEmpty(language) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(language)
            };
        })), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntil(A2($elm$parser$Parser$Advanced$Token, "\n", $elm$parser$Parser$Problem("Expecting newline")))), $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, "\n", $elm$parser$Parser$ExpectingSymbol("\n"))))), A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr("\n" + delimiter)), $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, "\n" + delimiter, $elm$parser$Parser$ExpectingSymbol(delimiter)))), $elm$parser$Parser$Advanced$chompWhile(function (c) {
    ...
    var $author$project$Parser$Token$greaterThan = A2($elm$parser$Parser$Advanced$Token, ">", $elm$parser$Parser$Expecting("a `>`"));
    var $elm$parser$Parser$Advanced$Located = F3(function (row, col, context) {
        return { bl: col, l: context, cE: row };
    });
    var $elm$parser$Parser$Advanced$changeContext = F2(function (newContext, s) {
        return { bl: s.bl, l: newContext, p: s.p, h: s.h, cE: s.cE, b: s.b };
    });
    var $elm$parser$Parser$Advanced$inContext = F2(function (context, _v0) {
        var parse = _v0;
        return function (s0) {
            var _v1 = parse(A2($elm$parser$Parser$Advanced$changeContext, A2($elm$core$List$cons, A3($elm$parser$Parser$Advanced$Located, s0.cE, s0.bl, context), s0.l), s0));
            if (!_v1.$) {
                var p = _v1.a;
                var a = _v1.b;
                var s1 = _v1.c;
                return A3($elm$parser$Parser$Advanced$Good, p, a, A2($elm$parser$Parser$Advanced$changeContext, s0.l, s1));
            }
            else {
                var step = _v1;
                return step;
    ...
    var $author$project$Parser$Token$lessThan = A2($elm$parser$Parser$Advanced$Token, "<", $elm$parser$Parser$Expecting("a `<`"));
    var $author$project$Markdown$LinkReferenceDefinition$destinationParser = A2($elm$parser$Parser$Advanced$inContext, "link destination", $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$url$Url$percentEncode), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$lessThan)), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntil($author$project$Parser$Token$greaterThan)), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$greaterThan))),
        $elm$parser$Parser$Advanced$getChompedString($author$project$Parser$Extra$oneOrMore(function (c) {
            return !$author$project$Helpers$isGfmWhitespace(c);
        }))
    ])));
    var $author$project$Parser$Token$closingSquareBracket = A2($elm$parser$Parser$Advanced$Token, "]", $elm$parser$Parser$Expecting("a `]`"));
    var $author$project$Parser$Token$openingSquareBracket = A2($elm$parser$Parser$Advanced$Token, "[", $elm$parser$Parser$Expecting("a `[`"));
    var $author$project$Markdown$LinkReferenceDefinition$labelParser = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Markdown$Helpers$prepareRefLabel), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$openingSquareBracket)), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntil($author$project$Parser$Token$closingSquareBracket)), $elm$parser$Parser$Advanced$symbol(A2($elm$parser$Parser$Advanced$Token, "]:", $elm$parser$Parser$Expecting("]:")))));
    var $author$project$Parser$Token$doubleQuote = A2($elm$parser$Parser$Advanced$Token, "\"", $elm$parser$Parser$Expecting("a double quote"));
    ...
    var $author$project$Markdown$LinkReferenceDefinition$onlyWhitespaceTillNewline = A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$chompWhile(function (c) {
        return (c !== "\n") && $author$project$Helpers$isGfmWhitespace(c);
    }), $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$newline),
        $elm$parser$Parser$Advanced$end($elm$parser$Parser$Expecting("end of file"))
    ])));
    var $author$project$Helpers$requiredWhitespace = A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$chompIf, $author$project$Helpers$isGfmWhitespace, $elm$parser$Parser$Expecting("gfm whitespace")), $elm$parser$Parser$Advanced$chompWhile($author$project$Helpers$isGfmWhitespace));
    var $author$project$Parser$Token$singleQuote = A2($elm$parser$Parser$Advanced$Token, "'", $elm$parser$Parser$Expecting("a single quote"));
    var $author$project$Markdown$LinkReferenceDefinition$titleParser = function () {
        var inSingleQuotes = A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Maybe$Just), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$singleQuote)), A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$andThen, $author$project$Markdown$LinkReferenceDefinition$hasNoBlankLine, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntil($author$project$Parser$Token$singleQuote))), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$singleQuote)), $author$project$Markdown$LinkReferenceDefinition$onlyWhitespaceTillNewline));
        ...
        return A2($elm$parser$Parser$Advanced$inContext, "title", $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
            $elm$parser$Parser$Advanced$backtrackable(A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$Helpers$requiredWhitespace), $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
                inDoubleQuotes,
                inSingleQuotes,
                $elm$parser$Parser$Advanced$succeed($elm$core$Maybe$Nothing)
            ])))),
            A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Maybe$Nothing), $author$project$Markdown$LinkReferenceDefinition$onlyWhitespaceTillNewline)
        ])));
    }();
    var $author$project$Helpers$spaceOrTab = A2($elm$parser$Parser$Advanced$chompIf, $author$project$Helpers$isSpaceOrTab, $elm$parser$Parser$Expecting("space or tab"));
    var $author$project$Helpers$upToThreeSpaces = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $author$project$Helpers$spaceOrTab, $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $author$project$Markdown$LinkReferenceDefinition$parser = A2($elm$parser$Parser$Advanced$inContext, "link reference definition", A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed(F3(function (label, destination, title) {
        return _Utils_Tuple2(label, { cg: destination, cK: title });
    })), $author$project$Helpers$upToThreeSpaces), A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $author$project$Markdown$LinkReferenceDefinition$labelParser, $elm$parser$Parser$Advanced$chompWhile($author$project$Helpers$isSpaceOrTab)), $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$newline),
        $elm$parser$Parser$Advanced$succeed(0)
    ]))), $elm$parser$Parser$Advanced$chompWhile($author$project$Helpers$isSpaceOrTab))), $author$project$Markdown$LinkReferenceDefinition$destinationParser), $author$project$Markdown$LinkReferenceDefinition$titleParser));
    ...
    var $author$project$Parser$Extra$tokenHelp = function (_char) {
        return $elm$parser$Parser$Advanced$token(A2($elm$parser$Parser$Advanced$Token, _char, $elm$parser$Parser$Expecting(_char)));
    };
    ...
    var $author$project$ThematicBreak$parseThematicBreak = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        $author$project$ThematicBreak$withChar("-"),
        $author$project$ThematicBreak$withChar("*"),
        $author$project$ThematicBreak$withChar("_")
    ]));
    var $author$project$ThematicBreak$singleSpace = A2($elm$parser$Parser$Advanced$chompIf, $author$project$ThematicBreak$isSpace, $elm$parser$Parser$Expecting("Space"));
    var $author$project$ThematicBreak$parser = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $author$project$ThematicBreak$singleSpace), $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $author$project$Markdown$Parser$innerParagraphParser = A2($elm$parser$Parser$Advanced$mapChompedString, F2(function (rawLine, _v0) {
        return $author$project$Markdown$RawBlock$Body(rawLine);
    }), $elm$parser$Parser$Advanced$chompUntilEndOr("\n"));
    ...
    var $author$project$Markdown$Parser$joinRawStringsWith = F3(function (joinWith, string1, string2) {
    ...
    var $author$project$Markdown$Parser$joinStringsPreserveAll = F2(function (string1, string2) {
        return string1 + ("\n" + string2);
    });
    var $author$project$Markdown$Parser$possiblyMergeBlocks = F2(function (state, newRawBlock) {
        return {
            af: state.af,
            T: function () {
                        ...
                        switch (_v0.a.$) {
                            case 5:
                                if (_v0.b.a.$ === 5) {
                                    ...
                                    var block2 = _v1.a.a;
                                    var rest = _v1.b;
                                    return A2($elm$core$List$cons, $author$project$Markdown$RawBlock$CodeBlock({
                                        b6: A2($author$project$Markdown$Parser$joinStringsPreserveAll, block2.b6, block1.b6),
                            ...
                            case 6:
                                if (_v0.b.a.$ === 6) {
                                    ...
                                    var block2 = _v2.a.a;
                                    var rest = _v2.b;
                                    return A2($elm$core$List$cons, $author$project$Markdown$RawBlock$IndentedCodeBlock(A2($author$project$Markdown$Parser$joinStringsPreserveAll, block2, block1)), rest);
                                }
                                else {
                                    break _v0$5;
                                }
                            case 10:
                                if (_v0.b.a.$ === 10) {
                                    ...
                                    var body2 = _v4.a.a;
                                    var rest = _v4.b;
                                    return A2($elm$core$List$cons, $author$project$Markdown$RawBlock$BlockQuote(A2($author$project$Markdown$Parser$joinStringsPreserveAll, body2, body1)), rest);
                                }
                                else {
                                    break _v0$5;
                                }
                            case 1:
                                switch (_v0.b.a.$) {
                                    case 10:
                                        ...
                                        var body2 = _v3.a.a;
                                        var rest = _v3.b;
                                        return A2($elm$core$List$cons, $author$project$Markdown$RawBlock$BlockQuote(A3($author$project$Markdown$Parser$joinRawStringsWith, "\n", body2, body1)), rest);
                                    case 1:
                                        var body1 = _v0.a.a;
                                        var _v5 = _v0.b;
                                        var body2 = _v5.a.a;
                                        var rest = _v5.b;
                                        return A2($elm$core$List$cons, $author$project$Markdown$RawBlock$Body(A3($author$project$Markdown$Parser$joinRawStringsWith, "\n", body2, body1)), rest);
                                    default:
                                        break _v0$5;
                                }
                            default:
                ...
                return A2($elm$core$List$cons, newRawBlock, state.T);
            }()
        };
    });
    ...
    var $author$project$Parser$Token$asterisk = A2($elm$parser$Parser$Advanced$Token, "*", $elm$parser$Parser$Expecting("a `*`"));
    var $author$project$Parser$Token$minus = A2($elm$parser$Parser$Advanced$Token, "-", $elm$parser$Parser$Expecting("a `-`"));
    var $author$project$Parser$Token$plus = A2($elm$parser$Parser$Advanced$Token, "+", $elm$parser$Parser$Expecting("a `+`"));
    var $author$project$Markdown$UnorderedList$listMarkerParser = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Parser$Token$minus), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$minus)),
        A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Parser$Token$plus), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$plus)),
        A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Parser$Token$asterisk), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$asterisk))
    ]));
    var $author$project$Markdown$ListItem$PlainItem = function (a) {
        return { $: 1, a: a };
    };
    var $author$project$Markdown$ListItem$TaskItem = F2(function (a, b) {
        return { $: 0, a: a, b: b };
    });
    var $author$project$Markdown$ListItem$Complete = 1;
    var $author$project$Markdown$ListItem$Incomplete = 0;
    var $author$project$Markdown$ListItem$taskItemParser = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
    ...
    var $author$project$Markdown$ListItem$parser = A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$succeed($author$project$Markdown$ListItem$TaskItem), A2($elm$parser$Parser$Advanced$ignorer, $author$project$Markdown$ListItem$taskItemParser, $author$project$Parser$Extra$zeroOrMore($author$project$Helpers$isSpaceOrTab))),
        $elm$parser$Parser$Advanced$succeed($author$project$Markdown$ListItem$PlainItem)
    ])), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$getChompedString($elm$parser$Parser$Advanced$chompUntilEndOr("\n")), $author$project$Helpers$endOfLineOrFile));
    var $author$project$Markdown$UnorderedList$itemBody = $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
        A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $elm$parser$Parser$Advanced$backtrackable($author$project$Parser$Extra$oneOrMore($author$project$Helpers$isSpaceOrTab))), $author$project$Markdown$ListItem$parser),
        A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($author$project$Markdown$ListItem$PlainItem("")), $elm$parser$Parser$Advanced$symbol($author$project$Parser$Token$newline))
    ]));
    var $author$project$Markdown$UnorderedList$singleItemParser = function (listMarker) {
        return A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$succeed($elm$core$Basics$identity), $elm$parser$Parser$Advanced$backtrackable($elm$parser$Parser$Advanced$symbol(listMarker))), $author$project$Markdown$UnorderedList$itemBody);
    };
    var $author$project$Markdown$UnorderedList$statementsHelp = F3(function (itemParser, firstItem, revStmts) {
        return $elm$parser$Parser$Advanced$oneOf(_List_fromArray([
            A2($elm$parser$Parser$Advanced$map, function (stmt) {
                return $elm$parser$Parser$Advanced$Loop(A2($elm$core$List$cons, stmt, revStmts));
            }, itemParser),
    ...
    var $author$project$Markdown$UnorderedList$parser = function () {
        var parseSubsequentItems = F2(function (listMarker, firstItem) {
            return A2($elm$parser$Parser$Advanced$loop, _List_Nil, A2($author$project$Markdown$UnorderedList$statementsHelp, $author$project$Markdown$UnorderedList$singleItemParser(listMarker), firstItem));
        });
        return A2($elm$parser$Parser$Advanced$andThen, $elm$core$Basics$identity, A2($elm$parser$Parser$Advanced$keeper, A2($elm$parser$Parser$Advanced$keeper, $elm$parser$Parser$Advanced$succeed(parseSubsequentItems), A2($elm$parser$Parser$Advanced$ignorer, $elm$parser$Parser$Advanced$backtrackable($author$project$Markdown$UnorderedList$listMarkerParser), $author$project$Parser$Extra$oneOrMore($author$project$Helpers$isSpaceOrTab))), $author$project$Markdown$ListItem$parser));
    }();
    var $author$project$Markdown$Parser$unorderedListBlock = function () {
        ...
        return A2($elm$parser$Parser$Advanced$map, A2($elm$core$Basics$composeR, $elm$core$List$map(parseListItem), $author$project$Markdown$RawBlock$UnorderedListBlock), $author$project$Markdown$UnorderedList$parser);
    }();
    var $author$project$Markdown$Parser$childToBlocks = F2(function (node, blocks) {
        switch (node.$) {
            case 0:
                var tag = node.a;
                ...
                if (!_v28.$) {
                    ...
                    var block = $author$project$Markdown$Block$HtmlBlock(A3($author$project$Markdown$Block$HtmlElement, tag, attributes, childrenAsBlocks));
            ...
            case 2:
                var string = node.a;
                return $elm$core$Result$Ok(A2($elm$core$List$cons, $author$project$Markdown$Block$HtmlBlock($author$project$Markdown$Block$HtmlComment(string)), blocks));
            case 3:
                var string = node.a;
                return $elm$core$Result$Ok(A2($elm$core$List$cons, $author$project$Markdown$Block$HtmlBlock($author$project$Markdown$Block$Cdata(string)), blocks));
            case 4:
                var string = node.a;
                return $elm$core$Result$Ok(A2($elm$core$List$cons, $author$project$Markdown$Block$HtmlBlock($author$project$Markdown$Block$ProcessingInstruction(string)), blocks));
            default:
                var declarationType = node.a;
                var content = node.b;
                return $elm$core$Result$Ok(A2($elm$core$List$cons, $author$project$Markdown$Block$HtmlBlock(A2($author$project$Markdown$Block$HtmlDeclaration, declarationType, content)), blocks));
        }
    });
    var $author$project$Markdown$Parser$inlineParseHelper = F2(function (referencesDict, _v21) {
        var unparsedInlines = _v21;
        var referencesDict2 = $elm$core$Dict$fromList(A2($elm$core$List$map, $elm$core$Tuple$mapSecond(function (_v22) {
            var destination = _v22.cg;
            var title = _v22.cK;
            return _Utils_Tuple2(destination, title);
        }), referencesDict));
        return A2($elm$core$List$map, $author$project$Markdown$Parser$mapInline, A2($author$project$Markdown$InlineParser$parse, referencesDict2, unparsedInlines));
    });
    var $author$project$Markdown$Parser$mapInline = function (inline) {
        switch (inline.$) {
            ...
            case 3:
                ...
                return A3($author$project$Markdown$Block$Link, string, maybeString, A2($elm$core$List$map, $author$project$Markdown$Parser$mapInline, inlines));
            case 4:
                var string = inline.a;
                var maybeString = inline.b;
                var inlines = inline.c;
                return A3($author$project$Markdown$Block$Image, string, maybeString, A2($elm$core$List$map, $author$project$Markdown$Parser$mapInline, inlines));
            case 5:
                var node = inline.a;
            ...
            default:
                ...
                switch (level) {
                    case 1:
                        return $author$project$Markdown$Block$Emphasis(A2($elm$core$List$map, $author$project$Markdown$Parser$mapInline, inlines));
                    case 2:
                        return $author$project$Markdown$Block$Strong(A2($elm$core$List$map, $author$project$Markdown$Parser$mapInline, inlines));
                    default:
                        return $author$project$Markdown$Block$Strong(A2($elm$core$List$map, $author$project$Markdown$Parser$mapInline, inlines));
                }
        }
            ...
            case 0:
                ...
                var parseChild = function (child) {
                    if (child.$ === 1) {
                        ...
                        return _List_fromArray([
                            $author$project$Markdown$Block$HtmlBlock($author$project$Markdown$Parser$nodeToRawBlock(child))
                        ]);
                    }
                };
                return A3($author$project$Markdown$Block$HtmlElement, tag, attributes, A2($elm$core$List$concatMap, parseChild, children));
            case 2:
                var string = node.a;
    ...
    var $author$project$Markdown$Parser$nodesToBlocksHelp = F2(function (remaining, soFar) {
    ...
    var $author$project$Markdown$Parser$parse = function (input) {
        var _v12 = A2($elm$parser$Parser$Advanced$run, A2($elm$parser$Parser$Advanced$ignorer, $author$project$Markdown$Parser$cyclic$rawBlockParser(), $author$project$Helpers$endOfFile), input);
        if (_v12.$ === 1) {
            var e = _v12.a;
            return $elm$core$Result$Err(e);
        }
    ...
    var $author$project$Markdown$Parser$parseAllInlines = function (state) {
        return A3($author$project$Markdown$Parser$parseAllInlinesHelp, state, state.T, _List_Nil);
    };
    var $author$project$Markdown$Parser$parseAllInlinesHelp = F3(function (state, rawBlocks, parsedBlocks) {
        parseAllInlinesHelp: while (true) {
            if (rawBlocks.b) {
                var rawBlock = rawBlocks.a;
                var rest = rawBlocks.b;
                var _v11 = A2($author$project$Markdown$Parser$parseInlines, state.af, rawBlock);
                switch (_v11.$) {
                    case 1:
    ...
    var $author$project$Markdown$Parser$parseInlines = F2(function (linkReferences, rawBlock) {
        switch (rawBlock.$) {
            case 0:
                ...
                if (!_v4.$) {
                    ...
                    return $author$project$Markdown$Parser$ParsedBlock(A2($author$project$Markdown$Block$Heading, parsedLevel, A2($author$project$Markdown$Parser$inlineParseHelper, linkReferences, unparsedInlines)));
                }
                else {
                    var e = _v4.a;
            ...
            case 1:
                ...
                return $author$project$Markdown$Parser$ParsedBlock($author$project$Markdown$Block$Paragraph(A2($author$project$Markdown$Parser$inlineParseHelper, linkReferences, unparsedInlines)));
            case 2:
                var html = rawBlock.a;
            ...
            case 3:
                ...
                var parseItem = function (unparsed) {
                    ...
                    var parsedInlines = A3($author$project$Markdown$Parser$parseRawInline, linkReferences, $elm$core$Basics$identity, unparsed.b6);
                    return A2($author$project$Markdown$Block$ListItem, task, parsedInlines);
                };
                return $author$project$Markdown$Parser$ParsedBlock($author$project$Markdown$Block$UnorderedList(A2($elm$core$List$map, parseItem, unparsedItems)));
            case 4:
                var startingIndex = rawBlock.a;
                var unparsedInlines = rawBlock.b;
                return $author$project$Markdown$Parser$ParsedBlock(A2($author$project$Markdown$Block$OrderedList, startingIndex, A2($elm$core$List$map, A2($author$project$Markdown$Parser$parseRawInline, linkReferences, $elm$core$Basics$identity), unparsedInlines)));
            case 5:
            ...
            case 10:
                ...
                var _v6 = A2($elm$parser$Parser$Advanced$run, $author$project$Markdown$Parser$cyclic$rawBlockParser(), rawBlocks);
                if (!_v6.$) {
                    var value = _v6.a;
            ...
            default:
                ...
                var parseHeader = function (_v9) {
                    ...
                    var wrap = function (parsedHeaderLabel) {
                        return { aQ: alignment, aE: parsedHeaderLabel };
                    };
                    return A3($author$project$Markdown$Parser$parseRawInline, linkReferences, wrap, label);
                };
                return $author$project$Markdown$Parser$ParsedBlock(A2($author$project$Markdown$Block$Table, A2($elm$core$List$map, parseHeader, header), _List_Nil));
        }
    });
    var $author$project$Markdown$Parser$parseRawInline = F3(function (linkReferences, wrap, unparsedInlines) {
        return wrap(A2($author$project$Markdown$Parser$inlineParseHelper, linkReferences, unparsedInlines));
    });
    var $author$project$Markdown$Parser$stepRawBlock = function (revStmts) {
        ...
        if (_v2.b && (_v2.a.$ === 1)) {
            return A2($elm$parser$Parser$Advanced$map, function (f) {
                return f(revStmts);
            }, $elm$parser$Parser$Advanced$oneOf($author$project$Markdown$Parser$cyclic$whenPreviousWasBody()));
        }
        else {
            return A2($elm$parser$Parser$Advanced$map, function (f) {
                return f(revStmts);
            }, $elm$parser$Parser$Advanced$oneOf($author$project$Markdown$Parser$cyclic$whenPreviousWasNotBody()));
        }
    };
    var $author$project$Markdown$Parser$textNodeToBlocks = function (textNodeValue) {
        return A2($elm$core$Result$withDefault, _List_Nil, $author$project$Markdown$Parser$parse(textNodeValue));
    };
        ...
        switch (xmlNode.$) {
            ...
            case 0:
                ...
                if (!_v1.$) {
                    ...
                    return $elm$parser$Parser$Advanced$succeed($author$project$Markdown$RawBlock$Html(A3($author$project$Markdown$Block$HtmlElement, tag, attributes, parsedChildren)));
                }
                else {
                    var err = _v1.a;
            ...
            default:
                ...
                return $elm$parser$Parser$Advanced$succeed($author$project$Markdown$RawBlock$Html(A2($author$project$Markdown$Block$HtmlDeclaration, declarationType, content)));
        }
    };
    function $author$project$Markdown$Parser$cyclic$whenPreviousWasNotBody() {
        return _List_fromArray([
            A2($elm$parser$Parser$Advanced$map, F2(function (_v25, revStmts) {
                return $elm$parser$Parser$Advanced$Done(revStmts);
            }), $author$project$Helpers$endOfFile),
            A2($elm$parser$Parser$Advanced$map, F2(function (block, revStmts) {
                return $elm$parser$Parser$Advanced$Loop(A2($author$project$Markdown$Parser$possiblyMergeBlocks, revStmts, block));
            }), $author$project$Markdown$Parser$parseAsParagraphInsteadOfHtmlBlock),
            A2($elm$parser$Parser$Advanced$map, F2(function (reference, revStmts) {
                return $elm$parser$Parser$Advanced$Loop(A2($author$project$Markdown$Parser$addReference, revStmts, reference));
            ...
            A2($elm$parser$Parser$Advanced$map, F2(function (block, revStmts) {
                ...
                A2($elm$parser$Parser$Advanced$map, $author$project$Markdown$RawBlock$CodeBlock, $elm$parser$Parser$Advanced$backtrackable($author$project$Markdown$CodeBlock$parser)),
    ...
    function $author$project$Markdown$Parser$cyclic$whenPreviousWasBody() {
        return _List_fromArray([
            A2($elm$parser$Parser$Advanced$map, F2(function (_v23, revStmts) {
                return $elm$parser$Parser$Advanced$Done(revStmts);
            }), $author$project$Helpers$endOfFile),
            A2($elm$parser$Parser$Advanced$map, F2(function (block, revStmts) {
                return $elm$parser$Parser$Advanced$Loop(A2($author$project$Markdown$Parser$possiblyMergeBlocks, revStmts, block));
            ...
            A2($elm$parser$Parser$Advanced$map, F2(function (block, revStmts) {
                ...
                $author$project$Markdown$Parser$blockQuote,
                A2($elm$parser$Parser$Advanced$map, $author$project$Markdown$RawBlock$CodeBlock, $elm$parser$Parser$Advanced$backtrackable($author$project$Markdown$CodeBlock$parser)),
                A2($elm$parser$Parser$Advanced$map, function (_v24) {
                    return $author$project$Markdown$RawBlock$ThematicBreak;
                }, $elm$parser$Parser$Advanced$backtrackable($author$project$ThematicBreak$parser)),
                $author$project$Markdown$Parser$unorderedListBlock,
    ...
    function $author$project$Markdown$Parser$cyclic$rawBlockParser() {
        return A2($elm$parser$Parser$Advanced$loop, { af: _List_Nil, T: _List_Nil }, $author$project$Markdown$Parser$stepRawBlock);
    }
    ...
    var $author$project$Benchmarks$compare = F2(function (title, markdown) {
        return A2($elm_explorations$benchmark$Benchmark$benchmark, title, function (_v0) {
    ...
    var $author$project$Benchmarks$suite = A2($elm_explorations$benchmark$Benchmark$describe, "markdown parsing", _List_fromArray([$author$project$Benchmarks$heading, $author$project$Benchmarks$elmMarkdownExplorationsReadme, $author$project$Benchmarks$withHeadingsAndLists, $author$project$Benchmarks$withHeadingsAndListsAndHtml]));
